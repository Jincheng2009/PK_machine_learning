...
df <- fread("D:/CTLA4_pop PK simulation_1_10mpk/sim_data/processed_df_downsample_time_cohort20.csv")
...
write.csv(data.frame(subject=train.subj), 
          file = "D:/CTLA4_pop PK simulation_1_10mpk/sim_data/train_subject_downsample_time_cohort20.csv",
...
write.csv(test.df, file = "D:/CTLA4_pop PK simulation_1_10mpk/results/lm_xgb_prediction_downsample_timepoints_cohort20.csv",
